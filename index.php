...
$arrayProdotti=[
    ...
    new Prodotto('Cibo per cani', 'Pedigree', 10.99, 'Cibo', new Cane('Cane', 'Labrador'), 'https://shop-cdn-m.mediazs.com/bilder/fai/scorta/pedigree/adult/classic/x/g/umido/cane/1/800/612758_pedigree_classic_24x400g_1.jpg', ['Carne', 'Carote']),
    new Prodotto('Cibo per gatti', 'Whiskas', 8.99, 'Cibo', new Gatto('Gatto', 'Siamese'), 'https://images.eprice.it/nobrand/0/Lightbox/462/202927462/BEFC0587-E47B-41C6-B169-41EF2C94FDEF.jpg', ['Pesce']),
      ...
      <div class="col-4">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <p class="card-text">Categoria: <?php echo $prodotto->getCategoria() ?>, Razza:
            ...
            <ul>
              <?php foreach ($prodotto->materiali as $materiale): ?>
